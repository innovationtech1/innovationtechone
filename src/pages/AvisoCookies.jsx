...
import logocookies from '../assets/img/thumb.png'
import'../App.css'
  ...
  return (
	  <div className="cookies">
		  ...
		  <div className="textConteiner">
			  <img className="logoCookies" src={logocookies} alt="cookies" />
		...
		<p>Si tiene cualquier duda acerca de nuestra política de cookies, puede contactar con esta página web a través
		  ...
		  <button> <NavLink className="active" to="/innovationtechone/">Regresar</NavLink></button>
